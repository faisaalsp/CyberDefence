    ...
    execute: function () {
      ...
      var Enemy = exports('Enemy', (_dec = ccclass('Enemy'), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        function Enemy() {
          ...
          _this = _Component.call.apply(_Component, [this].concat(args)) || this;
          _this.speed = 200; // Kecepatan gerak enemy
    ...
    execute: function () {
      ...
      var MainGame = exports('MainGame', (_dec = ccclass('MainGame'), _dec2 = property({
        ...
        function MainGame() {
          ...
          _initializerDefineProperty(_this, "bulletLifetime", _descriptor5, _assertThisInitialized(_this));
        ...
        _proto.start = function start() {
          ...
          if (this.score >= 5 && Math.random() < 0.5) {
            this.schedule(this.spawnEnemyRandomly, 1); // Make enemy larger
          } else {
            this.schedule(this.spawnEnemyRandomly, 3); // Normal size
          }
        ...
        _proto.spawnEnemyRandomly = function spawnEnemyRandomly() {
          ...
          this.enemyNode = instantiate(this.enemyPrefab); // Adjust the size of the enemy if score >= 20

          if (this.score >= 5 && Math.random() < 0.5) {
            this.enemyNode.setScale(new Vec3(2, 2, 2)); // Make enemy larger
          } else {
            this.enemyNode.setScale(new Vec3(1, 1, 1)); // Normal size
          }
        ...
        _proto.spawnBullet = function spawnBullet() {
          ...
          bulletNode.setRotation(this.ship.rotation);
